...
<link rel="stylesheet" type="text/css" href="bootstrap.min.css">
 ...
 <div class="container">
 	<div class="row">
 		<div class="col-md-8">
 <form action="newest.php" method="post" enctype="multipart/form-data">
 	<br/><h2>Upload Section for Newest Items</h2>
 	<input type="file" class="btn btn-primary" placeholder="upload" name="image" /><br/>
 	<h3>Description</h3>
...
<h1>Upload</h1>
<p>
Here you can upload all the new stuffs.
